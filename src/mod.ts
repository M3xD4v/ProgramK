...
import {
    DatabaseServer
} from "@spt-aki/servers/DatabaseServer";
import {
    ILogger
} from "@spt-aki/models/spt/utils/ILogger";
import {
    JsonUtil
} from "@spt-aki/utils/JsonUtil";
...
class Mod implements IPostDBLoadMod {
    public postDBLoad(container: DependencyContainer): void {
       ...
       logger.log("Program K Loaded", "yellow");
        ...
        logger.log(database.templates.items["366DGW"]._props, "yellow");
